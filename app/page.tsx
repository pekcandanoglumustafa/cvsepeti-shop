    ...
    <main>
      ...
      <section className="bg-[var(--surface)] border-b border-[var(--line)]">
        <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm">
          <div className="flex items-center gap-3">
            <Truck className="text-[var(--gold)]" size={28} />
          ...
          <div className="flex items-center gap-3">
            <ShieldCheck className="text-[var(--gold)]" size={28} />
          ...
          {mainCategories.map((cat) => {
            ...
            return (
              <Link
                ...
                className="relative group h-56 overflow-hidden border border-[var(--line)] bg-[var(--surface)] rounded-lg"
              >
                {img && (
                  <Image
                    src={img}
      ...
      <section className="max-w-7xl mx-auto px-4 py-14">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            href="/urunler"
            className="tag-stencil text-sm text-[var(--gold)] hover:underline flex items-center gap-1"
          >
