...
import { MapPin, Clock, Mail, Lock } from "lucide-react";
    ...
    <footer className="bg-[var(--ink)] text-[var(--paper)] mt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-xs text-[var(--paper-deep)] mt-6 mb-2">
            Ödemeleriniz iyzico güvencesiyle korunmaktadır.
          </p>
          <div className="inline-flex items-center gap-1.5 mt-1 bg-[var(--paper)] text-[var(--ink)] text-xs font-display tag-stencil px-3 py-1.5 rounded-sm">
            <Lock size={12} className="text-[var(--safety-orange)]" />
            iyzico ile Öde
          </div>
        </div>
      </div>
