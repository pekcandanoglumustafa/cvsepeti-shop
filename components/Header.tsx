...
import { ShoppingCart, Menu, X, Phone, Lock } from "lucide-react";
      ...
      <div className="bg-[var(--ink)] text-[var(--paper)] text-xs sm:text-sm">
        <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden sm:flex items-center gap-1.5 tag-stencil tracking-wider text-[var(--paper-deep)]">
              <Lock size={14} className="text-[var(--safety-orange)]" />
